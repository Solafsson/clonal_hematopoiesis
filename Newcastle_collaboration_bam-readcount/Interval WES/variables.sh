...
working_dir="/lustre/scratch119/humgen/projects/cnv_15x/clonal_hematopoiesis_ibd/newcastle_collaboration/Interval_WES/"

# script dir on NFS
script_dir="/nfs/users/nfs_a/ar31/Interval_WES_scripts/"
