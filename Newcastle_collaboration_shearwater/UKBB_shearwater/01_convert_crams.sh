...
bsub -J "cram2bam[1-${nrGenomes}]%1000" -q normal -M800 -R'span[hosts=1] select[mem>800] rusage[mem=800]' \
...
${cram_fileList} ${samtools_path} ${referenceFile} ${script_dir} ${convert_siteList}
