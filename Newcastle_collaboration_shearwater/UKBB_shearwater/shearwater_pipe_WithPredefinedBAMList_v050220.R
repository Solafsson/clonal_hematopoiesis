...
shearwater_fun = "/nfs/users/nfs_a/ar31/shearwater/shearwater_UKBB/wrapper_shearwaterML_multiplebams_v050220.R"; # Add path to this script if necessary
...
# Loading input files
cases = read.table(samples1_file, header=0, stringsAsFactors=F);
normals = read.table(samples2_file, header=0,  stringsAsFactors=F);
b = read.table(baits_bed, header=0,  stringsAsFactors=F)
