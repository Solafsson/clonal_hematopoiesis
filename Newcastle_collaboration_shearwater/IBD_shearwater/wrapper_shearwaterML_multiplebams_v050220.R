...
genome_file = "/lustre/scratch119/humgen/teams/anderson/users/so11/SVs_in_ibd/Homo_sapiens_assembly38/Homo_sapiens_assembly38.fasta";
...
#removed by ar31 to match "chr1" (vs "1") chormosome notation
