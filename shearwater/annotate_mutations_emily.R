# RUN like this:
# cd /lustre/scratch119/casm/team154pc/em16/CHIP/shearwater/
# nohup /software/R-3.4.0/bin/Rscript annotate_mutations_emily.R >& emily.log
...
library("ggplot2")
library("stringr")
setwd("/lustre/scratch119/casm/team154pc/em16/CHIP/shearwater/")
